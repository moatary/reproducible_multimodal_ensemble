...
run_adaboost.py
==================
Run AdaBoost with paper-optimal hyperparameters, averaged over 10 seeds.
"""
...
N_EST=100; LR=0.1; BASE_D=2; ALG="SAMME"

def build_model(seed):
    from sklearn.tree import DecisionTreeClassifier
    from sklearn.ensemble import AdaBoostClassifier
    base = DecisionTreeClassifier(max_depth=BASE_D, random_state=seed)
    return AdaBoostClassifier(estimator=base, n_estimators=N_EST,
                               learning_rate=LR, algorithm=ALG, random_state=seed)
