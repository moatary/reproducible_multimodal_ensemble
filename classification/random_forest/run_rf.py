...
run_randomforest.py
======================
Run RandomForest with paper-optimal hyperparameters, averaged over 10 seeds.
"""
...
N_EST=200; MAX_DEPTH=None; FEATURES="sqrt"; MIN_LEAF=1; CRIT="entropy"
...
def build_model(seed):
    ...
    return RandomForestClassifier(n_estimators=N_EST, criterion=CRIT,
                                   ...
                                   max_features=FEATURES, random_state=seed, n_jobs=-1)
