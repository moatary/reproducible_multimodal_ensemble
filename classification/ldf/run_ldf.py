...
run_ldf.py
=============
Run LDF with paper-optimal hyperparameters, averaged over 10 seeds.
"""
...
N_EST=100; BASE_D=10; CRIT="entropy"; DISC="lda"

def build_model(seed):
    import sys; sys.path.insert(0, "..")
    from model.ldt_models import LinearDiscriminantForest
    return LinearDiscriminantForest(n_estimators=N_EST, max_depth=BASE_D,
                                    tree_criterion=CRIT, discriminator=DISC,
                                    random_state=seed)
