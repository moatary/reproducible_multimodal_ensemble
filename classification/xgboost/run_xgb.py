...
run_xgboost.py
=================
Run XGBoost with paper-optimal hyperparameters, averaged over 10 seeds.
"""
...
N_EST=300; MAX_DEPTH=6; LR=0.05; SUBSAMPLE=0.8; COLSAMPLE=0.8

def build_model(seed):
    from xgboost import XGBClassifier
    return XGBClassifier(n_estimators=N_EST, max_depth=MAX_DEPTH,
                          learning_rate=LR, subsample=SUBSAMPLE,
                          colsample_bytree=COLSAMPLE, eval_metric="logloss",
